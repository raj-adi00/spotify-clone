...
//     if (currentplayed != clicked) {
//         document.querySelector(".circle").style.left = "0%";
//         audio = new Audio(path[currentplayed]);
//         audio.play();
...
//     let div = document.createElement("div");
//     div.innerHTML = a;
//     let val = div.getElementsByTagName("script");
//     let y = [];
//     let z;
//     for (let x of val) {
//         if (x.hasAttribute("type") && x.hasAttribute("data-target"))
//             y.push(x);
//     }
//     z = y[1].innerText;
//     z=await JSON.parse(z);
//     z=z.payload.tree.items;
//     for(let x of z)
//     {
//         songs.push(x["name"]);
//        path.push(`https://github.com/raj-adi00/spotify-clone/tree/main`+x["path"]+"?raw=true")
//     }
//     // console.log(z);
//     console.log(path);
//     return songs;
